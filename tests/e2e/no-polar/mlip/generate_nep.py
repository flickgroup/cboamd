"""Generate cached NEP reference dipole trajectories for the no-polar MLIP tests.
...
For each lambda it runs a 1000-step CO2 trajectory (driver=nep, no polarizability,
